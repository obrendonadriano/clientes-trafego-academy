          ...
          <section className="space-y-8">
            ...
            <div className="space-y-5">
              <h2 className="max-w-3xl font-display text-5xl leading-tight font-semibold tracking-[-0.05em] sm:text-6xl">
                Um portal premium para apresentar campanhas, métricas e
                relatórios com IA.
              </h2>
              <p className="max-w-2xl text-lg leading-8 text-muted-foreground">
                Projeto isolado do site principal, pronto para rodar localmente
                agora e preparado para deploy futuro no subdomínio oficial.
              </p>
            </div>
